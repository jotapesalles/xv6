...
_date: formato do arquivo elf32-i386
  ...
  12:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  25:	8b 45 f0             	mov    -0x10(%ebp),%eax
  28:	ff 75 f4             	pushl  -0xc(%ebp)
  2b:	ff 34 85 40 08 00 00 	pushl  0x840(,%eax,4)
  32:	ff 75 ec             	pushl  -0x14(%ebp)
  35:	ff 75 e0             	pushl  -0x20(%ebp)
  38:	ff 75 e4             	pushl  -0x1c(%ebp)
  3b:	ff 75 e8             	pushl  -0x18(%ebp)
  3e:	68 bc 07 00 00       	push   $0x7bc
  43:	ff 35 28 0b 00 00    	pushl  0xb28
  ...
  56:	50                   	push   %eax
  57:	50                   	push   %eax
  58:	68 a0 07 00 00       	push   $0x7a0
  5d:	ff 35 24 0b 00 00    	pushl  0xb24
  63:	e8 c8 03 00 00       	call   430 <printf>
  68:	83 c4 10             	add    $0x10,%esp
  6b:	eb b8                	jmp    25 <main+0x25>
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb 74 08 00 00       	mov    $0x874,%ebx
        while(*s != 0){
